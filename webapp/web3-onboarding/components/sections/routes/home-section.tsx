    ...
    <div className="space-y-16 py-8">
      ...
      <section className="text-center space-y-6">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
          Transform your Web2 knowledge into Web3 expertise through personalized learning paths, 
          interactive tutorials, and hands-on experience.
        </p>
      ...
      <section className="space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">Master these fundamentals before diving deeper</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Understanding decentralization, consensus mechanisms, and blockchain architecture.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {[
            {
              ...
              description: "Learning adapted to your experience level and goals"
            },
            {
              icon: Shield,
              title: "Practice Safely",
              description: "Risk-free environment to experiment with Web3 concepts"
            },
            {
              icon: Brain,
              title: "AI Assistance",
      ...
      <section className="text-center space-y-6 bg-gradient-to-r from-blue-500/10 to-violet-500/10 rounded-lg p-12">
        <h2 className="text-3xl font-bold">Ready to Start Your Web3 Journey?</h2>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Join thousands of developers who are already building the future of the internet.
